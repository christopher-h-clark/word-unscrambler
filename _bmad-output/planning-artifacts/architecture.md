...
- Single input field accepting 3-10 character combinations (letters a-z, case-insensitive, plus ? wildcard)
...
- **Dictionary Management:** File-based (SCOWL 2024.11.24 English word list, filtered to 3-10 letter words), loaded once at startup
