...
function ListItemLink(props: IListItemLinkProps): React.JSX.Element {
  ...
  return (
    ...
    >
      ...
      <List>
        ...
        <ListItem disablePadding>
          <ListItemLink to="/styled-example" primary="Styled" icon={<StyledIcon />} />
        </ListItem>
        <ListItem disablePadding>
          <ListItemLink to="/router-example/1234" primary="Router" icon={<RouterIcon />} />
        </ListItem>
      </List>
    </Drawer>
  );
